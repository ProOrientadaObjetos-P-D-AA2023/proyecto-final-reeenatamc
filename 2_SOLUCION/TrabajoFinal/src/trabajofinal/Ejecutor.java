    ...
    public static void main(String[] args) {
        ...
        while (bandera) {
            ...
            if (opcion < 5) {
                ...
                if (personaActual != null && personaActual.getCantidadPlanes() >= MAX_PLANES_POR_PERSONA) {
                    System.out.println("Ya has alcanzado el máximo de planes (2) permitidos por persona.");
                    continue;
                }
            }
